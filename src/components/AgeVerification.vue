<template>
  ...
  <section v-if="showPopup" >
   ...
   <div v-if="showLoading" class="fixed inset-0 z-50 bg-fur-blue text-neutral-1 flex items-center justify-center flex-col overflow-hidden">
    <div class="flex flex-col items-center gap-[2rem] justify-center p-[2rem] pt-[10rem] md:pt-[18rem]">
       <h2 class="text-neutral-6 text-center pb-[1rem]">Velkommen til Fur Bryghus</h2>
    ...
    <div class="flex flex-row w-screen items-center justify-center">
      <img src="../assets/images/desktop/hvede.png" alt="Hvede øl" class="h-[350px] md:h-[600px] beer-image">
       <img src="../assets/images/desktop/lager.png" alt="Lager øl" class="h-[350px] md:h-[600px] beer-image">
        <img src="../assets/images/desktop/renaessance.png" alt="Renæssance øl" class="h-[350px] md:h-[600px] beer-image">
        <img src="../assets/images/desktop/hvede.png" alt="Hvede øl" class="h-[300px] md:h-[600px] beer-image hidden lg:block">
       <img src="../assets/images/desktop/lager.png" alt="Lager øl" class="h-[300px] md:h-[600px] beer-image hidden lg:block">
        <img src="../assets/images/desktop/renaessance.png" alt="Renæssance øl" class="h-[300px] md:h-[600px] beer-image hidden lg:block">
    </div>
   </div>
   ...
   <!-- når loading skærmen er færdig og false vises aldersbekræftelses popuppen -->
    ...
    <div class="bg-white text-black p-[1.5rem] text-center w-[300px] md:w-[400px] shadow-lg  flex items-center justify-center flex-col">
