<template>
  ...
  <section class="flex flex-col items-center">
    <div class="md:flex flex-col md:justify-center md:h-[700px] md:w-full lg:h-[500px] px-[1rem] md:px-[3rem] py-[3rem] gap-3 xl:max-w-[1240px] md:max-w-[60%]">
      ...
      <p>På Fur Bryghus sætter vi en stor ære i at skabe de helt perfekte rammer for netop Jeres fest. Uanset om I skal holde rund fødselsdag, bryllup, jubilæum eller kon rmation, kan I være sikre på, at vi står til rådighed og sørger for, at I og jeres gæster vil få en dag, I vil huske lang tid fremover.</p>
      <p>Vi sætter personlig rådgivning i højsædet, og vi er først tilfredse, når I er tilfredse. Vi står til disposition igennem hele forløbet fra planlæg- ning til afholdelse af Jeres selskab. Alle forslagene er inkl. borddækning, dekorationer, moms samt venlig og smilende betjening.</p>
      <p>Lad os holde et uforpligtende møde, så vi sammen kan skabe netop de rammer, som I ønsker til Jeres fest. Vi ser frem til at gøre jeres dag unik!</p>
