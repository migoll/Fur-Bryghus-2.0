  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="mt-[1rem]">
          <p>
            Vi besøgte Bryghuset 2 gange i løbet af påsken og spiste der begge
            gange, 1. gang udenfor i gården om eftermiddagen og anden gang i
            restauranten om aftenen. Begge gange var det en superdejlig
            oplevelse, maden, omgivelserne, servering og selvfølgeligt
            fantastisk øl til maden. Vi kommer helt sikkert igen og lader os
            forkæle.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div class="mt-[1rem]">
          <p>
            Fantastisk oplevelse efter en lang dag på cykel rundt på Fur.Skønt
            øl på en dejlig sommeraften. God betjening som var søde til at
            fortælle os der var lidt ventetid på maden. Men i godt selskab med
            god øl, så går det meste. Der var også et fint legeområde for
            børnene, med bl.a. hoppepude.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div class="mt-[1rem]">
          <p>
            Fantastisk perle beliggende på en skøn lille ø i Limfjorden. Maden
            var take away, men helt perfekt anrettet. Vi nød et Skaldyrsfad
            efterfulgt af et fad med påsketapas. Det var svært at dele, da det
            hele var utroligt lækkert. 5 stjerner herfra.
          </p>
        </div>
      </div>
    </div>
