<template>
  ...
  <div class="swiper bg-fur-blue">
    ...
    >
      ...
      <div
        class="swiper-slide !flex flex-col md:flex-row items-center justify-center lg:px-[4rem] max-w-screen"
        v-for="beer in beers"
        :key="beer.id"
      >
        <div>
          ...
          <img
            ...
            class="h-[20rem] md:h-[30rem] object-cover"
          />
        </div>
        <div class="!flex flex-col items-center md:items-start">
          <!-- her vises navn og introtitel der hentes for hver øl -->
          <h2
            class="text-neutral-6 text-center md:text-left text-h2 md:text-h2-md font-anton"
          >
            {{ beer.acf.navn }}
          </h2>
          ...
          <div
            class="flex items-center md:items-start justify-center flex-col text-center lg:flex-row md:text-left md:mt-[10rem]"
          >
