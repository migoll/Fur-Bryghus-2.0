<template>
  ...
  <section
    :class="[
      ...
      // herunder defineres hvordan baggrundsbilledet sættes hvis der findes det
    ...
    :style="
      bgImage
        ? `background-image: url(${bgImage}); background-size:
  ...
  >
    ...
    >
      <div class="lg:w-1/2">
        ...
        <h2
          :class="[
            'mb-[1rem] scroll-fade text-h2 md:text-h2-md font-anton',
            headingColor,
          ]"
        >
          {{ heading }}
